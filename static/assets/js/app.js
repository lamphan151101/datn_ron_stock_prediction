...
function checkScreenWidth() {
  ...
  // Get the elements with the .sidebar-mini class
  var elementsWithClass = document.querySelectorAll('.sidebar-mini');

  // Check if screen width is 767px or smaller
  if (screenWidth <= 767) {
    // Remove the class from all matching elements
