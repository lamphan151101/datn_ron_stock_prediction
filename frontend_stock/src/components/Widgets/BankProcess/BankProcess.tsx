...
const BankProcess: React.FC = () => {
  ...
  const [selectedBank, setSelectedBank] = useState<BankDetail | undefined>();

  useEffect(() => {
    const dataArray: BankDetail[] = [
      {
        id: 1,
        name: 'Ziraat Bank',
  ...
  const handleViewOnChange = (e: ChangeEvent<HTMLSelectElement>): void => {
